...
require "#{File.dirname(__FILE__)}/game/lib/dragonjson/json.rb"
...
require "#{File.dirname(__FILE__)}/game/lib/wfc/wfc.rb"
...
require "#{File.dirname(__FILE__)}/game/scenes/map_scene.rb"
